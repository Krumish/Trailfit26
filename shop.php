...
$view_type = isset($_GET['view']) ? $_GET['view'] : 'grid'; // Default to grid view
?>
...
<section class="products">
   ...
   <div class="box-container <?php echo $view_type; ?>">
      <?php
      ...
      <form action="" method="POST" class="box">
         ...
         <div class="stock">
            Stock: <?php echo $fetch_products['stock'] > 0 ? $fetch_products['stock'] : 'Out of Stock'; ?>
         </div>
